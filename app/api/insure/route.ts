...
import { fetchFlightInfo, getScheduledDepartureUtc } from '@/src/flight'
import { auditLogger } from '@/lib/audit'
import { getClientIp } from '@/lib/auth'
import type { AppConfig, InsureRequest, InsureResponse } from '@/src/types'
...
export async function POST(request: NextRequest) {
  ...
  console.log(`[API] Insuring flight ${flightNumber} on ${date} → ${payoutAddress}`)
  ...
  try {
    ...
    return NextResponse.json({ error: 'Flight data unavailable' }, { status: 503 })
  }
