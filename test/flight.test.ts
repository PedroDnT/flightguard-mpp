  ...
  it('returns the scheduled UTC time when present', () => {
    const f = makeFlightInfo({
      departure: {
        iata: 'GRU',
        name: 'Guarulhos',
        scheduledTime: { local: '2026-04-01T10:00:00', utc: '2026-04-01T13:00:00Z' },
        delays: [],
      },
    })
...
describe('normalizeFlightInfo (via fetchFlightInfo) — regression: arrival.actualTime', () => {
  ...
  it('normalizes departure actualTime correctly', async () => {
    const raw = {
      ...
      status: 'Departed',
      departure: {
        scheduledTime: { local: '2026-03-22T08:00:00', utc: '2026-03-22T12:00:00Z' },
        actualTime: { local: '2026-03-22T09:10:00', utc: '2026-03-22T13:10:00Z' },
        delays: [{ minutes: 70 }],
