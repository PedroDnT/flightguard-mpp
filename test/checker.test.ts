...
import { FlightChecker } from "../src/domain/policies/checker.js";
import { store } from "../src/domain/policies/store.js";
...
vi.mock("../src/integrations/aerodatabox.js", async () => {
  const actual = await vi.importActual<
    typeof import("../src/integrations/aerodatabox.js")
  >("../src/integrations/aerodatabox.js");
  return { ...actual, fetchFlightInfo: vi.fn() };
});

// Fully mock payout: no blockchain calls
const mockSendPayout = vi.hoisted(() => vi.fn());
vi.mock("../src/integrations/payout.js", () => {
  return {
    PayoutEngine: class {
    ...
    buildPayoutMemo: vi
      .fn()
      .mockReturnValue("flightguard:test:AA123:2026-03-24"),
  };
});
...
function makeFlightInfo(overrides: Partial<FlightInfo> = {}): FlightInfo {
  return {
    ...
    departure: {
      ...
      name: "John F. Kennedy",
      scheduledTime: {
        local: "2026-03-24T10:00:00",
        utc: "2026-03-24T15:00:00Z",
      },
...
beforeEach(async () => {
  ...
  const m = await import("../src/integrations/aerodatabox.js");
...
describe("FlightChecker.runCycle", () => {
  ...
  it("case 1: marks policy expired when flight is cancelled", async () => {
    ...
    fetchFlightInfo.mockResolvedValue(
      makeFlightInfo({
        status: "Cancelled",
